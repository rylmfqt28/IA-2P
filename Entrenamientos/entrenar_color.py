...
data_entrenamiento = './data_color/entrenamiento'
data_validacion = './data_color/validacion'
...
# Al final de la epoca se corre 100 pasos con el set de datos de validacion
...
# Tamaño de filtro a usar en match pooling
tamano_pool = (2, 2)
...
# Ultima capa solo tiene 3 neuronas e indica en porcentajes la clasificacion correcta
...
# Corre 200 pasos en cada una de las epocas cuando termina corre 100 pasos de validacion y luego pasa a la otra epoca
...
cnn.save('./modelo_color/modelo_color.h5')
cnn.save_weights('./modelo_color/pesos_color.h5')
